...
class TestStarsData(unittest.TestCase):
    ...
    def test_star_get_three_coordinates(self):
        ...
        self.assertEqual([0, 0, 500], new_star.three_coordinates_default)
        ...
        for i in range(0, len(result)):
            self.assertTrue(
                math.fabs(result[i]-new2_star.three_coordinates_default[i]) < 10**(-6)
            )
    ...
    def test_get_constellations(self):
        stars_data.DATA_BASE = './tests/for tests/test_get_constellations/'
